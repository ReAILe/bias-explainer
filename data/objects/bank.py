...
class Bank():
    ...
    def __init__(self, verbose = True, config = 0):
        ...
        self.categorical_attributes = ['job', 'marital', 'education', 'default', 'housing', 'loan', 'contact', 'month', 'day_of_week', 'poutcome', 'target']
    ...
    def get_df(self, repaired = False):
        ...
        df['target'] = df.apply(lambda x: 1 if x['target'] == "yes" else 0, axis=1)
